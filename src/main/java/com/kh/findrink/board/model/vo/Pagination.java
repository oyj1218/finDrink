...
public class Pagination {
	...
	private void calculatePagination() {
		...
		// 전체 게시글 수 : 500개  // 보여지는 게시글의 수 : 10
		// -> 마지막 페이지 번호는 ? 500 / 10 = 50
		
		// 전체 게시글 수 : 501개  // 보여지는 게시글의 수 : 10
		...
		// prevPage(<) : 목록 하단에 노출된 번호의 이전 목록의 끝 번호
		// nextPage(>) : 목록 하단에 노출된 번호의 이전 목록의 시작 번호
		...
		// 현재 페이지가 41~50 일 경우 (maxPage는 50)
		// < : 40 페이지
		// > : 50 페이지
