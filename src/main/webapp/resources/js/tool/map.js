// https://apis.map.kakao.com/web/documentation/#services_Places_Methods
...
// 마커에 클릭 이벤트를 등록합니다
// 마커를 클릭하면 마지막 파라미터로 넘어온 함수를 호출합니다
...
//     type:'GET',
//     headers: {'Authorization' : '3f6bab40b2ac49c1e2a8db0a4766766f'},
...
//     oncomplete: function(data) {
        ...
        // $.ajax({
        //     url:"https://dapi.kakao.com/v2/local/search/address.json?y=37.514322572335935&x=127.06283102249932&radius=20000",
        //     type:'GET',
        //     data: {query:"서울 강남구 삼성동 159"},
        //     headers: {'Authorization' : 'KakaoAK 3f6bab40b2ac49c1e2a8db0a4766766f'},
        //     })
        //     .done(function (msg) {
        //         console.log(msg);
