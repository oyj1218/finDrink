...
function selectReplyList(){
    ...
    $.ajax({
        ...
        success : function(rList){
            ...
            const replyList = document.getElementById("reply-list"); // section3
            replyList.innerHTML = "";
            ...
            for(let reply of rList){
                ...
                replyRow.classList.add("section3-review");
                ...
                if(reply.profileImage != null){ // 프로필 이미지가 있는 경우
                    ...
                    profileImage.setAttribute("src", contextPath + reply.memberProfileImage);
                ...
                // 작성자 닉네임
                const memberNickname = document.createElement("h2");
                ...
                replyDate.classList.add("section3-enrolltime");
                replyDate.innerText = "등록일 : " + reply.createDate;

                // 작성자 영역(p)에 프로필, 내용, 등록일 마지막 자식으로 추가
                // replyWriter.append(memberNickname, replyContent, createDate);
                ...
                if(loginMemberNo == reply.memberNo){
                    ...
                    replyBtnArea.classList.add("section3-btn");
...
const addReply = document.getElementById("insertBtn");
