...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/mypage/user/usermyupdate-pg.css"/>
...
<body>
	...
	<script src="${contextPath}/resources/js/mypage/passwordCheck.js"></script>

	<script src="${contextPath}/resources/js/mypage/myPage.js"></script>
	<script src="${contextPath}/resources/js/mypage/updateValidate.js"></script>
</body>
</html>